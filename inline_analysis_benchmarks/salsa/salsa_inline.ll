...
define dso_local void @salsa20(i32* %out, i32* %in) #0 {
entry:
...
for.inc365:                                       ; preds = %for.body357
  ...
  br label %for.cond355, !llvm.loop !5
...
if.then.i:                                        ; preds = %for.body4
  call void @salsa20(i32* getelementptr inbounds ([16 x i32], [16 x i32]* @outbuf, i64 0, i64 0), i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0)) #2
  %8 = load i32, i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0), align 16
  %inc.i = add i32 %8, 1
  store i32 %inc.i, i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0), align 16
...
salsa.exit:                                       ; preds = %for.body4, %if.then.i
  ...
  store i32 %and.i, i32* @ptr, align 4
  %10 = load i32, i32* @ptr, align 4
  %idxprom.i = zext i32 %10 to i64
  %arrayidx.i = getelementptr inbounds [16 x i32], [16 x i32]* @outbuf, i64 0, i64 %idxprom.i
  %11 = load i32, i32* %arrayidx.i, align 4
  br label %for.inc5

for.inc5:                                         ; preds = %salsa.exit
...
for.end7:                                         ; preds = %for.cond2
  ...
  %cmp.i1 = icmp eq i32 %13, 0
  br i1 %cmp.i1, label %if.then.i4, label %salsa.exit9

if.then.i4:                                       ; preds = %for.end7
  call void @salsa20(i32* getelementptr inbounds ([16 x i32], [16 x i32]* @outbuf, i64 0, i64 0), i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0)) #2
  %14 = load i32, i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0), align 16
  %inc.i2 = add i32 %14, 1
  store i32 %inc.i2, i32* getelementptr inbounds ([16 x i32], [16 x i32]* @STATE, i64 0, i64 0), align 16
  %conv.i3 = zext i32 %14 to i64
  br label %salsa.exit9

salsa.exit9:                                      ; preds = %for.end7, %if.then.i4
  %15 = load i32, i32* @ptr, align 4
  %add.i5 = add i32 %15, 1
  %and.i6 = and i32 %add.i5, 15
  store i32 %and.i6, i32* @ptr, align 4
  %16 = load i32, i32* @ptr, align 4
  %idxprom.i7 = zext i32 %16 to i64
  %arrayidx.i8 = getelementptr inbounds [16 x i32], [16 x i32]* @outbuf, i64 0, i64 %idxprom.i7
  %17 = load i32, i32* %arrayidx.i8, align 4
  ...
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %20)
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i32 -162172867)
  %21 = load i32, i32* %val, align 4
  %cmp12 = icmp ne i32 %21, -162172867
