...
define dso_local void @myadd(float* %sum, float* %addend) #0 {
entry:
...
entry:
  %sum.addr.i = alloca float*, align 8
  %addend.addr.i = alloca float*, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %18 = bitcast float** %sum.addr.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %18)
  %19 = bitcast float** %addend.addr.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %19)
  store float* %ztot, float** %sum.addr.i, align 8
  store float* %z, float** %addend.addr.i, align 8
  %20 = load float*, float** %sum.addr.i, align 8
  %21 = load float, float* %20, align 4
  %22 = load float*, float** %addend.addr.i, align 8
  %23 = load float, float* %22, align 4
  %add.i = fadd float %21, %23
  %24 = load float*, float** %sum.addr.i, align 8
  store float %add.i, float* %24, align 4
  %25 = bitcast float** %sum.addr.i to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %25)
  %26 = bitcast float** %addend.addr.i to i8*
...
for.end:                                          ; preds = %for.cond
  ...
  %conv19 = fpext float %31 to double
  %32 = load i64, i64* %low, align 8
  %conv20 = trunc i64 %32 to i32
  %33 = load i64, i64* %j, align 8
  %conv21 = trunc i64 %33 to i32
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i64 0, i64 0), double %conv18, double %conv19, i32 %conv20, i32 %conv21)
  %34 = load i64, i64* %low, align 8
  %conv23 = sitofp i64 %34 to float
  %conv24 = fpext float %conv23 to double
  %mul25 = fmul double 4.000000e+00, %conv24
  %35 = load i64, i64* %itot, align 8
  %conv26 = sitofp i64 %35 to float
  ...
  %37 = load float, float* %ztot, align 4
  %conv31 = fpext float %37 to double
  %mul32 = fmul double %conv31, 0.000000e+00
  %38 = load i64, i64* %itot, align 8
  %conv33 = trunc i64 %38 to i32
  %call34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i64 0, i64 0), double %conv30, double %mul32, i32 %conv33)
  ret i32 0
}
